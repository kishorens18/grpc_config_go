...
func (c *myServiceClient) InsertData(ctx context.Context, in *InsertRequest, opts ...grpc.CallOption) (*InsertResponse, error) {
...
func (UnimplementedMyServiceServer) InsertData(context.Context, *InsertRequest) (*InsertResponse, error) {
...
func _MyService_InsertData_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MyServiceServer).InsertData(ctx, req.(*InsertRequest))
	}
